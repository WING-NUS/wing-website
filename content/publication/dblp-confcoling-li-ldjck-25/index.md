...
summary: 'DnA-Eval decomposes and aggregates LLM-as-judge evaluation to improve interpretability and agreement with human preferences.'
image:
  caption: 'Figure from Li et al. (2025).'
  preview_only: false
links:
- name: URL
