...
summary: 'KeYric improves symbolic-music-to-lyrics generation by extracting and expanding keyword skeletons for coherent, musically matched lyrics.'
image:
  caption: 'Figure from Ma et al. (2025).'
  preview_only: false
links:
- name: URL
