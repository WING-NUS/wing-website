---
title: "Michalis Vlachos Presents at the CSSH Seminar: Searching Digital Libraries with Language Models"
event: CSSH Seminar

location: "Room AS7-0102, The Shaw Foundation Building"
address:
  street: 5 Arts Link, Level 3, Singapore 117570
  city: Singapore
  region: ''
  postcode: '117570'
  country: Singapore
authors: [michalis] # we should make sure to use a person's alias if their profile has been created. 
tags: ["CSSH", "Digital Libraries", "Digital Humanities"]
...
summary: "Michalis Vlachos Presents at the CSSH Seminar: Searching Digital Libraries with Language Models"
---
...
_Below is a gallery of the seminar, photo credit to Min and Yisong!_

{{< figure src="featured.jpeg" alt="Michalis Vlachos at CSSH Seminar" >}}

{{< figure src="michalis-talk-1.jpeg" alt="Michalis Vlachos presenting at CSSH Seminar" >}}

{{< figure src="michalis-talk-2.jpeg" alt="Michalis Vlachos presenting at CSSH Seminar" >}}

{{< figure src="michalis-talk-3.jpeg" alt="Michalis Vlachos presenting at CSSH Seminar" >}}
