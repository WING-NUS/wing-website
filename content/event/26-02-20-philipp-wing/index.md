...
address:
  ...
  postcode: '117417'
  country: Singapore
authors: [Philipp Mayr, min] # we should make sure to use a person's alias if their profile has been created.
tags: ["AI Overload", "AI Governance", "Scholarly Document Processing", "GESIS"]
...
summary: "WING hosted Philipp Mayr from GESIS, with highlights on AI overload, oversight bottlenecks, and practical paths forward for trustworthy AI systems."
---
...
**Paper:** [AI Overload: A Multi-Level Taxonomy and the Path Forward](https://sentic.net/ai-overload.pdf)

We thank Philipp for the inspiring and thought-provoking talk! 

_Below is a gallery of the seminar, photo credit to Sahaj!_

{{< figure src="featured.jpeg" alt="Philipp Mayr introducing research projects at WING" >}}

{{< figure src="fig-1.jpg" alt="Philipp Mayr introducing research projects at WING" >}}

{{< figure src="fig-2.jpg" alt="Philipp Mayr introducing research projects at WING" >}}
